import { imgGroup, imgGroup101 } from "./svg-vnwfm";
...
function Group140() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <div className="absolute font-['Space_Grotesk:Medium',_sans-serif] font-medium leading-[0] left-[70.83px] text-[#c3c3c3] text-[15px] text-nowrap top-5 tracking-[-0.33px]">
...
export default function Group142() {
  return (
